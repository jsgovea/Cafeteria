...
location.href="alta_proveedor.php?codproveedor="+elCampo.value+"&nombre="+ elCampo2.value  +"" ;     
	}	
<!--
...
<div id="Layer1">
  <label></label>
  <form action="insertar.php?nombre=<?php echo $nombre;?>" id="selector" name="selector" method="post" enctype="multipart/form-data" >
 ...
 <textarea name="domicilio" cols="50" rows="5" id="domicilio"><?php echo $Domicilio;?></textarea>        <label>
      ...
      <tr>
        <td height="42"><input type="text" name="tel" id="tel" value="<?php echo $TEL;?>"></td>
        <td><input type="text" name="fax" id="fax" value="<?php echo $Fax;?>"></td>
        <td><input type="text" name="correo" id="correo" value="<?php echo $Correo;?>"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="43"><input type="text" name="contacto" id="contacto" value="<?php echo $Contacto;?>"></td>
        <td><label for="select"></label>
          <select name="credito" id="credito"  >
            <option value="N/A"><?php echo $Credito;?></option>
        ...
        <td><label for="label"></label>
          <select name="moneda" id="moneda" >
            <option value="N/A"><?php echo $TipoCambio;?></option>
