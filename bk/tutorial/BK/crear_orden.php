...
location.href="crear_orden.php?codproveedor="+elCampo.value+"&nombre="+ elCampo2.value  +"&iva="+ elCampo3.value  +"&fecha="+ elCampo4.value  +"" ;     
	}
...
<div id="container">
  ...
  <div id="g_image9" style="position:absolute; overflow:hidden; left:168px; top:961px; width:674px; height:47px; z-index:3; visibility: visible;"><img src="images/botmenu_bg.gif" alt="" border=0 width=673 height=47></div>
  <div id="g_image10" style="position:absolute; overflow:hidden; left:-43px; top:961px; width:187px; height:47px; z-index:4; visibility: visible;"><img src="images/bot1.gif" alt="" border=0 width=187 height=47></div>
  <div id="g_image8" style="position:absolute; overflow:hidden; left:140px; top:961px; width:28px; height:47px; z-index:5; visibility: visible;"><img src="images/bot2.gif" alt="" border=0 width=28 height=47></div>
  <div id="g_image4" style="position:absolute; overflow:hidden; left:149px; top:192px; width:756px; height:45px; z-index:6; visibility: visible;"><img src="images/products_b.gif" alt="" border=0 width=755 height=45></div>
  ...
  <div id="g_shape1" style="position:absolute; overflow:hidden; left:-44px; top:1012px; width:887px; height:15px; z-index:9; visibility: visible;"><img border=0 width="100%" height="100%" alt="" src="images/shape8198781.gif"></div>
...
AC_RunFlashContent('id','g_flash1','width','632','height','182','quality','high','autoplay','false','loop','true','wmode','transparent','codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab','pluginspage','http://www.macromedia.com/go/getflashplayer','src','images/swf7GGFB.swf');
  ...
  <div id="g_text3" style="position:absolute; overflow:hidden; left:396px; top:1013px; width:428px; height:30px; z-index:13; visibility: visible;">
    <div class="wpmd">
...
<div id="Layer1">
  <label></label>
  <form action="insertar3.php?nombre=<?php echo $nombre;?>&codproveedor=<?php echo $CodProveedor; ?>&iva=<?php echo $iva; ?>" id="selector" name="form1" method="post" enctype="multipart/form-data" >
    <table width="696" height="222" border="0">
      ...
      <tr>
        ...
        <td>Cantidad</td>
        <td><input type="hidden" name="flagname" id="flagname" value="<?php echo $nombre;?>"  ></td>
        <td><label for="textfield">Autoriza:</label></td>
        <td><a href="tuto1.php?nombre=<?php echo $nombre; ?>&$iva=<?php echo $iva; ?>&fecha=<?php echo $fecha; ?>&autorizo=<?php echo $autorizo; ?>&codproveedor=<?php echo  $codproveedor;?>"   title='Elimar Producto' ><img src="images/IconoImpresora.jpg" width="40" height="40" border="0"></a></td>
      </tr>
      <tr>
        ...
        <input type="text" name="cantidad" id="cantidad">          <label for="select"></label></td>
        <td><label for="select">
          <input name="Submit" type="submit" class="ws10" id="Submit" value="Agregar">
        </label>	    </td>
		 
        <td><a href="tuto1.php?nombre=<?php echo $nombre; ?>&$iva=<?php echo $iva; ?>&fecha=<?php echo $fecha1;?>&codproveedor=<?php echo  $codproveedor;?>"   title='Elimar Producto' >
          <label for="select"></label>
          <select name="autoriza" id="autoriza">
            <option value="JOSE ALONZO RAMIREZ FRANCO">Alonzo Ramirez</option>
          </select>
        </a> </td>
        <td>&nbsp;</td>
      </tr>
...
if ($colorfila==0)
    ...
    <td>".$row['Importe']."</td>
	<td>".$row['Moneda']."</td>        
   <td  bgcolor='#FFFFFF' ><a href=\"baja_orden.php?nombre=".$nombre."&flag=1&id=".$row['id']."&codproveedor=".$codproveedor."&iva=".$iva."&fecha=".$fecha."\"   title='Elimar Producto' > <img src ='images/Delete.ico'   border=0> </a></td> 
	 </tr>";
