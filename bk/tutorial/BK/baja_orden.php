...
<div id="Layer1">
	 ...
	 if($flag2==2)
 {
  echo "<script language=\"javascript\">
	   alert('Se elimino el registro','');
	   	window.location.href=\"modificar_orden.php?nombre=$nombre&numcompra=$numcompra&codproveedor=$codproveedor&iva=$iva&fecha=$fecha\";
		</script>";	
 ...
 if($flag==1)
 {
  echo "<script language=\"javascript\">
	   alert('Se elimino el registro','');
	   	window.location.href=\"crear_orden.php?nombre=$nombre&codproveedor=$codproveedor&iva=$iva&fecha=$fecha\";
		</script>";	
