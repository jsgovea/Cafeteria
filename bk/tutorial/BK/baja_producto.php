...
location.href="baja_producto.php?codproducto="+elCampo.value+"&nombre="+ elCampo2.value  +"" ;     
	}	
...
<div id="Layer1">
  <label></label>
  <form    action="procesa_baja_producto.php?nombre=<?php echo $nombre;?>&codproducto=<?php echo $codproducto;?>" id="selector" name="form1" method="post" enctype="multipart/form-data" onChange=" funcion(this, this.form);" >
