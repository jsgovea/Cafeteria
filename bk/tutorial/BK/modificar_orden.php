...
location.href="modificar_orden.php?numcompra="+elCampo.value+"&nombre="+ elCampo2.value  +"" ;    
	}
<!--
...
<div id="Layer1">
  <label></label>
  <form action="insertar4.php?numcompra=<?php echo $numcompra; ?>&Facturar=<?php echo $Facturar; ?>&Entregar=<?php echo $Entregar; ?>&iva=<?php echo $iva; ?>&nombre=<?php echo $nombre;?>&codproveedor=<?php echo $CodProveedor;?>" id="selector" name="form1" method="post" enctype="multipart/form-data" >
    <table width="696" height="169" border="0">
      ...
      <tr>
        ...
        <td><input type="submit" name="Submit" value="Agregar" id="Submit">
...
$sSQL = "SELECT * FROM orden_temp WHERE NumOrden='$numcompra2' ORDER BY CodProducto LIMIT ".($pagina-1)*$noRegistros.",$noRegistros";
...
if ($colorfila==0)
    ...
    <td>".$row['Importe']."</td>
	<td>".$row['Moneda']."</td>        
   <td  bgcolor='#FFFFFF' ><a href=\"baja_orden.php?nombre=".$nombre."&flag2=2&id=".$row['id']."&codproveedor=".$codproveedor."&numcompra=".$numcompra."&iva=".$iva."&fecha=".$fecha."\"   title='Elimar Producto' > <img src ='images/Delete.ico'   border=0> </a></td> 
	 </tr>";
	...
	echo "<hr>   "; 
   $result3 = mysql_query('SELECT sum(Importe) as suma FROM orden_temp WHERE NumOrden=\''.$numcompra2.'\' '); 
