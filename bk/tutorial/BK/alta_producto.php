...
location.href="alta_producto.php?codproducto="+elCampo.value+"&nombre="+ elCampo2.value  +"" ;     
	}	
<!--
...
<div id="Layer1">
  <label></label>
  <form action="insertar2.php?nombre=<?php echo $nombre;?>" id="selector" name="selector" method="post" enctype="multipart/form-data" >
    <table width="661" height="411" border="0">
      ...
      <tr>
        ...
        <td> <label for="label2"></label>
          <label>
          <input type="text" name="modeloproducto" id="modeloproducto" value="<?php echo $Modelo;?>">
          </label></td>
 ...
 <textarea name="descripcionproducto" cols="50" rows="5" id="descripcionproducto"><?php echo $Descripcion;?></textarea>        <label>
      ...
      <tr>
        <td height="42"><input type="text" name="marcaproducto" id="marcaproducto" value="<?php echo $Marca;?>"></td>
