...
if ($colorfila==0)
    ...
    <td  bgcolor='#FFFFFF' ><a href=\"procesa_baja.php?nombre=".$nombre."&flag=1&codproveedor=".$row['CodProveedor']."\"   title='Elimar Proveedor' > <img src ='images/Delete.ico'   border=0> </a></td>
