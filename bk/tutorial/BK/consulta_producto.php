...
<div id="container">
  ...
  <div id="g_text4" style="position:absolute; overflow:hidden; left:-18px; top:206px; width:165px; height:27px; z-index:11;">
    <div class="wpmd">
...
if ($colorfila==0)
    ...
    <td  bgcolor='#FFFFFF' ><a href=\"procesa_baja_producto.php?nombre=".$nombre."&flag=1&codproducto=".$row['CodProducto']."\"   title='Elimar Proveedor' > <img src ='images/Delete.ico'   border=0> </a></td>
...
for($i=1; $i<$noPaginas+1; $i++) { //Imprimo las páginas
    if($i == $pagina)
        ...
        echo "<a href=\"?pagina=".$i."&nombre=".$nombre."\">".$i."</a> ";
}
?>
</div>
</body>
