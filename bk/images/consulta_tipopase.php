...
<script language="javascript">
 function check(combo1)
    {
   
	
 var elCampo = document.getElementById('combo1');
	
 location.href="consulta_tipopase.php?variable="+elCampo.value+"";
  ...
  <ul id="css3menu1" class="topmenu">
    ...
    <li class="topmenu"><a href="index.php" style="height:15px;line-height:15px;"><span>CATALOGOS</span></a>
        <ul>
          ...
          <li><a href="consulta_tipopase.php">CATALOGOS X TIPOS DE PASE</a></li>
        </ul>
    </li>
      ...
      <tr>
        ...
        <td width="314"><form name="form2" method="post" action="consulta_depto.php">
          ...
          <p><strong>Tipo de pase :</strong>
            <select name="combo1" id="combo1" title="Tipo de pase para control interno o externo." onChange="check()">
              <option value=""> </option>
...
$sSQL = "SELECT * FROM pasesmuestra where CanceladoPor='".$escape."' AND MotivoCancelado='".$escape."'  AND tipopase='".$tipopase."' ORDER BY GrupoCode LIMIT ".($pagina-1)*$noRegistros.",$noRegistros";
