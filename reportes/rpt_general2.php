...
function Header()
{
	...
	$this->Cell(20,5,'Cliente',1,0,"L",1);
	$this->Cell(20,5,'Articulo#',1,0,"L",1);
	$this->Cell(45,5,'Descripcion',1,0,"L",1);
	$this->Cell(20,5,'Cantidad',1,0,"L",1);
	$this->Cell(18,5,'P/U',1,0,"L",1);
	$this->Cell(20,5,'Total',1,0,"L",1);
 	$this->Ln(5);	
...
while($ver2=mysqli_fetch_row($result2)){
 $id_venta=$ver2[0];
	...
	$pdf->Cell(10,5,$id_cajero,0,0,'',True);	
			$pdf->SetFont('Arial','',8);				
			$pdf->Cell(20,5,$id_producto,0,0,'',True);
			$pdf->SetFont('Arial','',8);			
			$pdf->Cell(20,5,$descripcion,0,0,'',True);	
			$pdf->SetFont('Arial','',8);			
			$pdf->Cell(50,5,$cantidad,0,0,'',True);	
