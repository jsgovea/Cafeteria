...
<div id="container">
  ...
  <div id="g_image2" style="position:absolute; overflow:hidden; left:14px; top:192px; width:187px; height:47px; z-index:6; visibility: visible;"><img src="images/users_feedback_s.gif" alt="" border=0 width=187 height=47></div>
  <div id="g_image9" style="position:absolute; overflow:hidden; left:232px; top:710px; width:762px; height:47px; z-index:9; visibility: visible;"><img src="images/botmenu_bg.gif" alt="" border=0 width=758 height=47></div>
  <div id="g_image10" style="position:absolute; overflow:hidden; left:22px; top:710px; width:187px; height:47px; z-index:10; visibility: visible;"><img src="images/bot1.gif" alt="" border=0 width=187 height=47></div>
  <div id="g_image8" style="position:absolute; overflow:hidden; left:204px; top:710px; width:28px; height:47px; z-index:12; visibility: visible;"><img src="images/bot2.gif" alt="" border=0 width=28 height=47></div>
  <div id="g_image4" style="position:absolute; overflow:hidden; left:219px; top:192px; width:769px; height:68px; z-index:2; visibility: visible;"><img src="images/products_b.gif" alt="" border=0 width=770 height=45></div>
  ...
  <div id="g_image7" style="position:absolute; overflow:hidden; left:16px; top:466px; width:196px; height:236px; z-index:5; visibility: visible;"><img src="images/new_releases_bg.gif" alt="" border=0 width=196 height=236></div>
  <div id="g_shape1" style="position:absolute; overflow:hidden; left:21px; top:761px; width:971px; height:15px; z-index:14; visibility: visible;"><img border=0 width="100%" height="100%" alt="" src="images/shape8198781.gif"></div>
  ...
  <div id="g_text4" style="position:absolute; overflow:hidden; left:1px; top:206px; width:165px; height:27px; z-index:16;">
    <div class="wpmd">
...
AC_RunFlashContent('id','g_flash1','width','632','height','182','quality','high','autoplay','false','loop','true','wmode','transparent','codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab','pluginspage','http://www.macromedia.com/go/getflashplayer','src','images/swf7GGFB.swf');
  ...
  <div id="g_text3" style="position:absolute; overflow:hidden; left:532px; top:762px; width:428px; height:30px; z-index:18; visibility: visible;">
    <div class="wpmd">
  ...
  <div id="marquee1" style="position:absolute; overflow:hidden; left:5px; top:226px; width:169px; height:209px; z-index:19; visibility: visible;">
...
<div id="image1" style="position:absolute; overflow:hidden; left:31px; top:685px; width:140px; height:47px; z-index:20; visibility: visible;"><img src="images/Mytek.png" alt="" border=0 width=140 height=47></div>
  ...
  <span class="ws12 ws12"><b><a href="alta_proveedor.php?nombre=<?php echo  $nombre; ?>&n=<?php echo $n; ?>&d=<?php echo $d; ?>" title="PROVEEDOR" target="_top" class="style1 ws9 ws10 ws12">Proveedor</a></b></span> </div>
  <table width="537" height="25" border="0">
    <tr>
      ...
      <td width="280" height="20"><div class="Estilo1 ws10" id="Layer7">
        ...
        <a href="crear_orden.php?nombre=<?php echo  $nombre; ?>&n=<?php echo $n; ?>&d=<?php echo $d; ?>" title="PROVEEDOR" target="_top" class="style1 ws9 ws10 Estilo4" onMouseMove="MM_showHideLayers('Layer10','','hide','Layer11','','hide','Layer15','','show','Layer16','','hide')">Orden de compra </a></div></td>
      <td width="280" height="20"><div class="ws10 Estilo1 Estilo2" id="Layer8"><strong><a href="index.php" title="PROVEEDOR" target="_top" class="style1 ws9 ws10 Estilo5">Salir</a></strong></div>
        <div id="Layer16">
 ...
 <th background="ALTA.php" class="ws10" scope="row"><div align="left"> <a href="Rep_proveedor.php?nombre=<?php echo  $nombre; ?>&n=<?php echo  $n; ?>&d=<?php echo $d; ?>" class="Estilo2 ws12 ws12 style1" ><em>Proveedor</em></a></div></th>
      ...
      <td width="280" height="20"><div class="Estilo4" id="Layer9" onMouseOver="MM_showHideLayers('Layer10','','hide','Layer11','','hide','Layer15','','hide','Layer16','','show')"><a href="crear_orden.php?nombre=<?php echo  $nombre; ?>&n=<?php echo $n; ?>&d=<?php echo $d; ?>" title="PROVEEDOR" target="_top" class="style1 ws10 Estilo5" onFocus="MM_showHideLayers('Layer10','','hide','Layer11','','hide','Layer15','','hide','Layer16','','show')">Reportes</a></div></td>
    </tr>
  </table>
</div>
...
<div class="ws10 style1" id="Layer14"><strong><font face="Tahoma">Consulta de productos. </font></strong></div>
<div id="Layer17">
  <div align="left"><br>  
      <span class="ws18">Consulta de articulos. </span></div>
</div>
...
if($n==2)
{
$sSQL = "SELECT * FROM producto ORDER BY id LIMIT ".($pagina-1)*$noRegistros.",$noRegistros";

}
else
{
$sSQL = "SELECT * FROM producto WHERE Depto=$d ORDER BY id LIMIT ".($pagina-1)*$noRegistros.",$noRegistros";
...
// Imprimiendo los resultado
	echo "<table width='100%' border='0px' cellspacing='1'>
		...
		<td bgcolor='".$color."' style='".$style."'>Modelo</td>
        <td bgcolor='".$color."' style='".$style."'>Descripcion</td>
        <td bgcolor='".$color."' style='".$style."'>Marca</td>
        <td bgcolor='".$color."' style='".$style."'>PrecioUni</td>
...
if ($colorfila==0)
    ...
    <td  bgcolor='#FFFFFF' ><a href=\"procesa_baja_producto.php?nombre=".$nombre."&flag=1&codproducto=".$row['CodProducto']."&n=".$n."&d=".$d."\"   title='Elimar Proveedor' > <img src ='images/Delete.ico'   border=0> </a></td>
...
//Imprimiendo páginas
	//$grupo=$row['GrupoCode'];
$sSQL = "SELECT count(*) FROM producto"; //Cuento el total de registros
...
$i=$i+4;
//echo "<b><p class='style1'>Página ".$i."</b>";
}
else
{
