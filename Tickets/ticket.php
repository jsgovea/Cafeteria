...
require_once "conexion.php";
	$conexion4=conexion2();
$sql="call consultaticket($idcajero)";
$result2=mysqli_query($conexion4,$sql);
				while($ver=mysqli_fetch_row($result2)){ $id_venta2=$ver[0]; }
...
$nota=$ver[8];
    ...
    $printer->text( "$cantidad  pieza    $pu $total   \n");
				}
...
require_once "conexion.php";
		$sql5="call totalticket($idcajero)";
